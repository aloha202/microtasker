...
class myActions extends sfActions {
	...
	protected function backWithError($error = 'Error') {
			$this->getUser()->setFlash('error', T::__($error));
			return $this->redirect($this->request->getReferer());		
	}
	protected function backWithNotice($notice = 'Error') {
			$this->getUser()->setFlash('notice', T::__($notice));
			return $this->redirect($this->request->getReferer());		
	}	
